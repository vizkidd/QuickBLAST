...
#' @export
CreateQuickBLASTInstance <- function(seq_type, strand, program, options = NULL, save_sequences = FALSE, save_hsp_sequences = FALSE, num_threads = 0L) {
    .Call(`_QuickBLAST_CreateQuickBLASTInstance`, seq_type, strand, program, options, save_sequences, save_hsp_sequences, num_threads)
}
...
#' @export
RemoteBLAST <- function(ptr, database, query_input, input_type, outFile = NULL, return_values = TRUE, max_poll_seconds = 360L, poll_interval_ms = 4000L) {
    .Call(`_QuickBLAST_RemoteBLAST`, ptr, database, query_input, input_type, outFile, return_values, max_poll_seconds, poll_interval_ms)
}
